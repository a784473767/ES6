...
//  if(com===1){
//      console.log('添加一个坐标：');
//      console.log('请添加一个横坐标');
//      let X=scanf('%d');
//      console.log('请添加一个纵坐标');
//          let y=scanf('%d');
//          let zuobiao={
//              'x':X,
//              'y':y,
...
//      for(let i=0;i<arr.length;i++){
//        let lrq=arr[i];
//        console.log(`第${i+1}个坐标为(${lrq.x},${lrq.y})`);
//       }
//       console.log('点击回车继续');
//       scanf('%d');
//     }
//     if(com===3){
//         console.log('3——删除最后一个纵坐标');
//         arr.pop();
//         console.log('按回车继续');
//         scanf('%d');
//     }
